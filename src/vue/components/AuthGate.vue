  ...
  <main class="min-h-screen bg-canvas lg:grid lg:grid-cols-2">
    ...
    >
      <div class="text-center">
        <AppLogo size="hero" />
        <p class="mt-7 text-base tracking-[.08em] text-white/68 uppercase">
          Your private course library
        </p>
      </div>
    </aside>
    ...
    >
      ...
      >
        ...
        <div v-if="status === 'loading'" class="px-8 py-10 text-sm text-muted lg:px-0">
          Checking your session…
        </div>

        <div v-else-if="status === 'error'" class="px-8 py-8 lg:px-0">
        ...
        <div v-else-if="isSetup && !setupEnabled" class="px-8 py-8 lg:px-0">
        ...
        <form v-else class="px-8 py-8 lg:px-0" @submit.prevent="submit">
