...
<template>
  <aside
    v-if="playlist"
    class="sticky top-0 flex h-[calc(100vh-66px)] flex-col border-l border-[#343b44] bg-porcelain text-ink min-[1024px]:h-screen max-[860px]:static max-[860px]:mx-[clamp(20px,3vw,50px)] max-[860px]:mb-10 max-[860px]:h-auto max-[860px]:w-auto max-[860px]:overflow-hidden max-[860px]:rounded-[7px] max-[860px]:border max-[860px]:border-line max-[600px]:mx-3"
