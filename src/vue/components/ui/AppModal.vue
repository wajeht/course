...
<template>
  <Teleport to="body">
    <dialog
      ref="dialog"
      class="m-auto max-h-[calc(100vh-40px)] w-[calc(100%-40px)] overflow-hidden rounded-[12px] border border-line bg-white p-0 text-ink shadow-[0_28px_90px_rgb(18_22_28_/_38%)] backdrop:bg-[#12161c]/45"
      :class="
        {
